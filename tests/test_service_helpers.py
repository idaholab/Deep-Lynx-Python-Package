...
class TestServiceHelpers:
    ...
    def test_nodes(self):
        ...
        # create metatype
        metatype = self.dl_service.create_metatype(
            self.dl_service.container_id,
            {
                "name": "Test",
        ...
        # retrieve node
        retrieve_node = self.dl_service.retrieve_node(
            self.dl_service.container_id,
            node_id
        )
        ...
        list_node_metatype = self.dl_service.list_nodes_by_metatype_id(
            self.dl_service.container_id,
            metatype_id
        )
        ...
        query_graph = self.dl_service.query(
            self.dl_service.container_id,
            '{nodes {id metatype{id} archived}}'
        )
        assert len(query_graph['data']['nodes']) > 0

        # archive node
        archive_node = self.dl_service.archive_node(
            self.dl_service.container_id,
            node_id
        )
    ...
    def test_edges(self):
        ...
        # create relationship
        relationship = self.dl_service.create_relationship(
            self.dl_service.container_id,
            {
                "name": "Test",
        ...
        # retrieve edge
        retrieve_edge = self.dl_service.retrieve_edge(
            self.dl_service.container_id,
            edge_id
        )
        ...
        # archive edge
        archive_edge = self.dl_service.archive_edge(
            self.dl_service.container_id,
            edge_id
        )
    ...
    def test_imports(self):
        ...
        # list import data
        list_import = self.dl_service.list_import_data(
            self.dl_service.container_id,
            import_id
        )
        ...
        import_data = self.dl_service.retrieve_import_data(
            self.dl_service.container_id,
            import_id,
            data_id
        )
    ...
    def test_users(self):
        ...
        # retrieve user
        retrieve_user = self.dl_service.retrieve_user(
            self.dl_service.container_id,
            user_id
        )
        ...
        # list user roles
        user_roles = self.dl_service.list_user_roles(
            self.dl_service.container_id,
            user_id
        )
    ...
    def test_metatypes(self):
        ...
        # retrieve metatype
        retrieve_metatype = self.dl_service.retrieve_metatype(
            self.dl_service.container_id,
            metatype_id
        )
        ...
        # update metatype
        update_metatype = self.dl_service.update_metatype(
            self.dl_service.container_id,
            metatype_id,
            {
                "name": "Test Metatype",
        ...
        # archive metatype
        archive_metatype = self.dl_service.archive_metatype(
            self.dl_service.container_id,
            metatype_id
        )
    ...
    def test_metatype_keys(self):
        ...
        retrieve_metatype_key = self.dl_service.retrieve_metatype_key(
            self.dl_service.container_id,
            metatype_id,
            metatype_key_id
        )
        ...
        # list metatype keys
        list_metatype_keys = self.dl_service.list_metatype_keys(
            self.dl_service.container_id,
            metatype_id
        )
        ...
        archive_metatype_key = self.dl_service.archive_metatype_key(
            self.dl_service.container_id,
            metatype_id,
            metatype_key_id
        )
    ...
    def test_metatype_relationships(self):
        ...
        retrieve_relationship = self.dl_service.retrieve_relationship(
            self.dl_service.container_id,
            relationship_id
        )
        ...
        # update relationship
        update_relationship = self.dl_service.update_relationship(
            self.dl_service.container_id,
            relationship_id,
            {
                "name": "Test Relationship",
        ...
        archive_relationship = self.dl_service.archive_relationship(
            self.dl_service.container_id,
            relationship_id
        )
    ...
    def test_relationship_keys(self):
        ...
        retrieve_relationship_key = self.dl_service.retrieve_relationship_key(
            self.dl_service.container_id,
            relationship_id,
            relationship_key_id
        )
        ...
        list_relationship_keys = self.dl_service.list_relationship_keys(
            self.dl_service.container_id,
            relationship_id
        )
        ...
        archive_relationship_key = self.dl_service.archive_relationship_key(
            self.dl_service.container_id,
            relationship_id,
            relationship_key_id
        )
    ...
    def test_relationship_pairs(self):
        ...
        # create metatypes
        metatype_1 = self.dl_service.create_metatype(
            self.dl_service.container_id,
            {
        ...
        metatype_2 = self.dl_service.create_metatype(
            self.dl_service.container_id,
            {
        ...
        retrieve_relationship_pair = self.dl_service.retrieve_relationship_pair(
            self.dl_service.container_id,
        ...
        archive_relationship_pair = self.dl_service.archive_relationship_pair(
            self.dl_service.container_id,
            relationship_pair_id
        )
